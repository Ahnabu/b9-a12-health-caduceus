    ...
    return (
        <>
            <div className='container mx-auto px-4 sm:px-8'>
                <Helmet>
                    <title>Health Caduceus ||Manage Registered</title>
                </Helmet>
                <div className='py-8'>
                                ...
                                {/* <Menu>
                                    ...
                                    <MenuList className="bg-primary bg-opacity-45">
                                        <MenuItem value={'campFees'}
                                            onClick={() => { setSort('campFees'), refetch() }} className="bg-primary bg-opacity-55 text-white" >Camp Fees</MenuItem>
                                        <MenuItem value={'confirmation_status'}
                                            className="bg-primary bg-opacity-55 text-white" onClick={() => { setSort('confirmation_status'), refetch() }}
                                        > Confirmation Status</MenuItem>
                                        ...
                                        return <tr key={participant._id} className='border border-secondary'>
                                            ...
                                            <td className='px-5 py-3'>
                                                ...
                                                <Button variant='outlined' className={`bg-primary text-secondary text-xl border-secondary`}
                                                    ...
                                                    {participant.confirmation_status == 'Pending' ? <MdCancel></MdCancel> : <ImBlocked></ImBlocked>}
                                                </Button>
                                            ...
                                            <td className='px-5 py-3'>
                                                  ...
                                                  <Button variant='outlined' className={`bg-primary text-secondary text-xl border-secondary p-0`}
                                                   ...
                                                   <DialogDefault participant={participant}></DialogDefault>
                                                </Button>
