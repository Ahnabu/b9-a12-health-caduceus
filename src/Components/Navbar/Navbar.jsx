...
export function StickyNavbar() {
    ...
    return (
        <div className=" w-full m-auto ">
            <Navbar className="fixed bg-transparent z-10 h-max max-w-full rounded-none px-2 md:px-4 py-2 lg:px-8 lg:py-4 bg-opacity-20 bg-primary">
 ...
 */}
                            ...
                            <Link to={'/register'}>
                                <Button
                                    className={`flex items-center text-secondary bg-white justify-center w-full p-3 font-semibold tracking-wide rounded-md dark:bg-violet-600 dark:text-gray-50 border border-secondary`}
                                >Join Us</Button>
                            </Link>
                ...
                <Collapse open={openNav}>
                    ...
                    <div className="flex items-center gap-x-1">
                        ...
                        {/* <Link to={'/login'}>
                            <Button fullWidth variant="text" size="sm" className="  text-secondary">
                                Log In
                            </Button>
                        </Link> */}
                        ...
                        <Link to={'/register'}>
                            <Button fullWidth variant="gradient" type="ghost" size="sm" className=" text-secondary">
                                Register
                            </Button>
                        </Link>
